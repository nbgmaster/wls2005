...
<td align=left height=47>&nbsp;<img src=images/fahrten.jpg></td>
<td valign=top align=right class=middle>
<font class=mini><br></font>

<?php 

$g_data_main = mysql_query("select * from $gallery_tblname WHERE cat='fahrten'");
...
$g_show_main = mysql_query("select * from $gallery_tblname WHERE cat='fahrten' ORDER BY id DESC LIMIT $g_side_forward_main,$g_anzeigen_main");
...
echo "<a href=\"index.php?page=gallery&class=fahrten&g_side_forward_main=$p\">[$lp]</a> "; 
...
<table width=700 align=center cellspacing=0 cellpadding=0 border=0 style="border: 1px solid #C0C0C0;">
<tr>

<td align=left valign=top>

<?php 
echo"<a href=\"index.php?page=gallery&class=fahrten&g_id=$g_row_main[0]\">";
...
$g_data_mai2 = mysql_query("select * from $gallery_tblname WHERE id > '$g_id' && cat='fahrten'");
...
<td align=left height=47>&nbsp;<img src=images/fahrten.jpg></td><td valign=top align=right class=middle>
<font class=mini><br></font>
<?php 
echo"<img src=images/arrow_r.gif> <b>Album:</b> $album";
echo" | <img src=images/arrow_r.gif>";

if($roy2=="0") {  echo" <a href=index.php?page=gallery&class=fahrten><b>Zur Album Übersicht</b></a>"; }

else { echo" <a href=index.php?page=gallery&class=fahrten&g_side_forward_main=$roy2><b>Zur Album Übersicht</b></a>"; }
...
echo "<a href=\"index.php?page=gallery&class=fahrten&g_id=$g_id&g_side_forward=$n\">[$sn]</a> "; 
