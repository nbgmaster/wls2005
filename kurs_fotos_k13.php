...
$blubb2="kurs_fotos_k13/$p_bild/big_picture/$blaaa.jpg";

$size2 = getimagesize($blubb2);
$width=$size2[0];
$height=$size2[1];

echo"<img src=images/arrow_r.gif><a href=\"javascript:OpenNewWindow('kurs_fotos_k13/$p_bild/big_picture/$blaaa.jpg',900,$height)\"><b> Bild vergrößern<b></a>";
...
echo"&nbsp;<a href=index.php?page=kurs_fotos_k13&p_bild=$p_bild&show_picture=2>[2]</a></b>";

}

else {

echo"<a href=index.php?page=kurs_fotos_k13&p_bild=$p_bild&show_picture=1>[1]</a>";
...
echo"<img src=\"kurs_fotos_k13/$p_bild/small_picture/$p_bild$nummer.jpg\" border=\"1\" class=\"muh\">";  }


if($show_picture=="2")  {


echo"<img src=\"kurs_fotos_k13/$p_bild/small_picture/$p_bild$nummer2.jpg\" border=\"1\" class=\"muh\">";  }
